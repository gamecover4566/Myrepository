...
public class StringMessageConverterRestController {
	...
	public String ajaxRequest(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		String msg = "";
	...
	public String ajaxRequestGETPOST(@RequestParam(value = "id", required = true, defaultValue = "" ) String id) {
		String msg = "";
		if(id.startsWith("guard")) {
			msg = "Y";
		}
